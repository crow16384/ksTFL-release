...
Generic function to add footer rows. Dispatches to class-specific
methods, allowing footers to be added to both spec objects and global
options.
...
Each call adds a new footer row. Per schema, footers are arrays of
